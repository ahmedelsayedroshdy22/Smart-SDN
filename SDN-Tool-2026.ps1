...
# Add customer names to the dropdown menu
 ...
 'Amcor Group Gmbh','Kuoni Global Travel Services Schweiz Ag','xella baustoffe gmbh','Test_Customer','pvh corp','google llc','Kion Information Mgmt Service Gmbh','Hp International Sarl','hp inc','kenvue brands llc','siemens healthineers ag','fujitsu services','envalior b.v.','singapore airlines ltd.','Philips Electronics Netherland Bv','Palfinger Ag','flowserve','ministry of business innovation and employment','Keller Management Services LLC','the goodyear tire and rubber company','kone oyj','')
